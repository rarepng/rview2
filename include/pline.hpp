...
class pline {
public:
	static bool init(rvkbucket &objs, VkPipelineLayout &playout, VkPipeline &pipeline, VkPrimitiveTopology topology,
	...
	static void cleanup(rvkbucket &objs, VkPipeline &pipeline);
};
