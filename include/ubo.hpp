...
inline void upload(rvkbucket &mvkobjs, std::vector<ssbodata>& ubodata, std::vector<glm::mat4> mats, const glm::vec3& campos) {
	//todo: fix this mess
...
inline void cleanup(rvkbucket &mvkobjs, std::vector<ssbodata>& ubodata) {
