...
public:
	...
	static bool upload(vkobjs& mvkobjs, VkCommandBuffer& cbuffer, vkvertexbufferdata& vbdata, const fastgltf::Buffer& buffer, const fastgltf::BufferView& bufferview, const fastgltf::Accessor& acc);
	static bool upload(vkobjs& mvkobjs, VkCommandBuffer& cbuffer, vkvertexbufferdata& vbdata, const std::vector<unsigned int>& jointz,const unsigned int count,const unsigned int ofx);
