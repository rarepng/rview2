...
inline bool init(rvkbucket &mvkobjs, GpuBuffer &vbdata, VkDeviceSize bsize, VkBufferUsageFlags usage) {
...
inline VkBufferMemoryBarrier2 record_upload(rvkbucket &mvkobjs,
