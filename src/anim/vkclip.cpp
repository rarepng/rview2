...
// void vkclip::addchan(std::shared_ptr<tinygltf::Model> model, const tinygltf::Animation& anim, const
// tinygltf::AnimationChannel& chann) { 	std::shared_ptr<vkchannel> chan = std::make_shared<vkchannel>();
