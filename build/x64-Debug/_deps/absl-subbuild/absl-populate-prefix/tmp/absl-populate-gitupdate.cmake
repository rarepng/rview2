...
execute_process(
  COMMAND "D:/smoke/Git/cmd/git.exe" --git-dir=.git show-ref "20240722.0"
  WORKING_DIRECTORY "D:/silver/qtcan/vulkan/build/x64-Debug/_deps/absl-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/silver/qtcan/vulkan/build/x64-Debug/_deps/absl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/silver/qtcan/vulkan/build/x64-Debug/_deps/absl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
